...
### 1. TDD - Rédaction de fonctions à partir de tests (15 minutes)
...
### 2. Rédaction de tests unitaires par description (10 minutes)
...
### 3. Rédaction de tests unitaires par code (5 minutes)
